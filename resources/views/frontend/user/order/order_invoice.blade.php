    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>Budi Mulya</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Budi Mulya Store
               Email:support@BudiMulya.com <br>
               Mob: 1245454545 <br>
  ...
  <table width=" 100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            <tr class="font">
                <td align="center">
                    <img class="image_edit" src="{{ $item->product->product_thumbnail }}" alt="">
                </td>
    ...
    <table width="100%" style=" padding:0 10px 0 10px;">
        <tr>
            <td align="right">
                <h2><span style="color: green;">Subtotal:</span> Rp {{ $order->amount }}</h2>
                <h2><span style="color: green;">Total:</span> Rp {{ $order->amount }}</h2>
