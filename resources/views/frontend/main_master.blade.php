...
<head>
  ...
  <title>Toko Bahan Kue Budi Mulya</title>
...
<body class="cnt-home">
  ...
  <script src="https://kit.fontawesome.com/2ac7fe0c77.js" crossorigin="anonymous"></script>
    ...
    function cart() {
      $.ajax({
        ...
        success: function(response) {
          ...
          $.each(response.carts, function(key, value) {
            rows += `<tr>
        <td class="col-md-1"><img src="/${value.options.image} " alt="imga" style="width:130px; height:130px;"></td>
              ...
              `<tr>
                <th>
                    ...
                    <div class="cart-sub-total">
                        ...
                        <button type="submit"><i class="fa fa-times" onclick="couponRemove()"></i> </button>
                    </div>
