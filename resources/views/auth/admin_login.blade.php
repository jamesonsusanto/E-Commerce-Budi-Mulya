...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{asset('backend/images/logo-crop.png')}}">

    <title>Budi Mulya Store Admin - Log in </title>
	...
	<style>
		.bg-image{
			background-image: url("{{asset('backend/images/background/bakery-background.jpg')}}");
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Welcome to Budi Mulya</h2>
							<p class="text-white-50">Sign in to shop</p>							
						</div>
