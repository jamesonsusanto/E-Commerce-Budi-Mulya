...
<div class="container-full">
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">Rp {{ $today  }} <small class="text-success"><i class="fa fa-caret-up"></i> Idr</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">Rp{{ $month }} <small class="text-success"><i class="fa fa-caret-up"></i> Idr</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">Rp{{ $year }} <small class="text-danger"><i class="fa fa-caret-down"></i> Idr</small></h3>
		</div>
	</div>
</div>
</div>
