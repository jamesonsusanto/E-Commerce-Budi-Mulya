  ...
  <section class="sidebar">
      ...
      <div class="ulogo">
        <a href="index.html">
          ...
          <div class="d-flex align-items-center justify-content-center">
            <img src="{{asset('backend/images/logo-small.png')}}" alt="" style="margin:15px">
            <h3><b>Budi Mulya</b> Shop</h3>
          </div>
        </a>
      </div>
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview {{($prefix=='/product')?'active':''}}">
        ...
        <ul class="treeview-menu">
          <li class="{{($route=='all.product')?'active':''}}"><a href="{{route('add-product')}}"><i class="ti-more"></i>Add Product</a></li>
